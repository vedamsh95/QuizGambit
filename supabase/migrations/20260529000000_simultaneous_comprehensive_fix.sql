-- ============================================================================
-- Simultaneous Mode — Comprehensive Fix
-- ============================================================================
-- 1. Remove last_seen heartbeat filters (same bug Arena mode had)
-- 2. Add simultaneous_answers to supabase_realtime publication
-- 3. Set REPLICA IDENTITY FULL on lobbies for reliable postgres_changes
-- ============================================================================

-- ── 1. Fix start_simultaneous_session: count ALL players ────────────────────
...
-- ── 2. Fix submit_simultaneous_answer: count ALL players ────────────────────
...
BEGIN
    ...
    -- Count ALL players in lobby (no heartbeat filter)
...
-- ── 3. Fix next_simultaneous_turn: count ALL players ────────────────────────
...
-- ── 4. Fix force_close_simultaneous_question: count ALL players ─────────────
...
-- ── 5. Add simultaneous_answers to supabase_realtime publication ────────────
...
-- ── 6. Set REPLICA IDENTITY FULL on lobbies (so postgres_changes sends full row) ──
