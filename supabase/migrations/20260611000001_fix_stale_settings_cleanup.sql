-- ============================================================================
-- Fix: reset_and_start_simultaneous_session doesn't clear all stale game keys
-- ============================================================================
-- Bug: When re-selecting a game mode, handleSelectMode clears draftPicks but
-- the RPC only removes revealed_questions/revealed_questions_by_round/draftPicks/
-- simultaneous_categories from settings. selectedCategories, draft, and
-- round_categories from previous games survive, causing stale categories to
-- appear on the new game's board.
-- Fix: Also remove selectedCategories, draft, and round_categories before merging.
-- ============================================================================
...
BEGIN
    ...
    -- 4. Atomically update the lobby: clear ALL old game keys, set new state
