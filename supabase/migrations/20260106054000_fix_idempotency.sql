...
DROP CONSTRAINT IF EXISTS unique_answer_per_turn;

ALTER TABLE arena_answers 
ADD CONSTRAINT unique_answer_per_turn UNIQUE (lobby_code, question_id, player_id);

-- 2. Update RPC to handle duplicates (Idempotency)
...
BEGIN
    ...
    ON CONFLICT (lobby_code, question_id, player_id) DO NOTHING;
